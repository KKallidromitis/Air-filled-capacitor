%Modified from skeleton code in ELEC2219: Electromagnetism for EEE.
...
capacitance1=(charge1/(Vcentral-Vedge))/(eps_0);
capacitance2=(charge2/(Vcentral-Vedge))/(eps_0);
capacitance3=(2*energy3)/((Vcentral-Vedge)^2)/(eps_0);
capacitance4=(2*energy4)/((Vcentral-Vedge)^2)/(eps_0);
capacitance5=(charge5/(Vcentral-Vedge))/(eps_0);
